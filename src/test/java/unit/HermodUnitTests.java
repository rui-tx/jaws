...
public class HermodUnitTests {
    ...
    @Test
    public void givenPriceParameterWithDollarSign_whenTemplateProcessed_thenPriceIsReplaced() throws IOException {
    ...
    @Test
    public void givenValueParameterWithDollarSign_whenTemplateProcessed_thenValueIsReplaced() throws IOException {
    ...
    @Test
    public void givenMultipleParameters_whenTemplateProcessed_thenParametersAreReplaced() throws IOException {
    ...
    @Test
    public void givenNoPlaceholders_whenTemplateProcessed_thenOriginalTemplateIsReturned() throws IOException {
    ...
    @Test
    public void givenInvalidCommandInTemplate_whenTemplateProcessed_thenLeaveUnchanged() throws IOException {
    ...
    @Test
    public void givenTemplateWithMultipleCommands_whenTemplateProcessed_thenAllCommandsExecute() throws IOException {
    ...
    @Test
    public void givenTemplateWithMixedPlaceholdersAndCommands_whenTemplateProcessed_thenAllReplacedCorrectly() throws IOException {
