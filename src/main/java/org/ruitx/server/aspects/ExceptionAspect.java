...
import org.ruitx.server.exceptions.APIException;
import org.ruitx.server.exceptions.APIParsingException;
...
public class ExceptionAspect {
    ...
    @Pointcut("execution(* org.ruitx.server.utils.APIHandler.*(..))")
