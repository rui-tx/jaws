package org.ruitx.jaws.components.bifrost;

import org.ruitx.jaws.components.yggdrasill.Yggdrasill;

/**
 * Middleware interface for processing HTTP requests and responses in a chain pattern. Middleware
 * can modify requests, handle authentication, logging, or other cross-cutting concerns.
 */
public interface Middleware {
  ...
  /**
   * Get the order/priority of this middleware. Lower numbers execute first. Default implementation
   * returns 100.
   *
