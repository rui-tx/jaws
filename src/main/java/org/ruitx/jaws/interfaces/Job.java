...
public interface Job {
  ...
  /**
   * Job type identifier used for routing to appropriate handlers Examples: "heavy-computation",
   * "external-api-call", "user-processing"
   */
  String getType();
  ...
  /**
   * Job payload containing all data needed for execution This includes request data, user context,
   * etc.
   */
  Map<String, Object> getPayload();

  /**
   * Execution mode - determines whether job runs in parallel or sequential queue Defaults to
   * PARALLEL
   */
   ...
   * <p>
   * This method should contain all the business logic that was previously in the async route
   * methods. It has access to all data through the payload and should store its result using
   * JobResultStore.
   *
