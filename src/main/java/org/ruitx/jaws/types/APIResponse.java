...
public record APIResponse<T>(
     ...
     * @return a new APIResponse instance indicating success with the provided code and data
     * and info message as an empty string
     */
     ...
     * @param data the response data
     * @param <T>  the type of the response data
     * @return a new APIResponse instance indicating success with default code and provided data
     * and info message as an empty string
     */
     ...
     * @param data the response data
     * @param <T>  the type of the response data
     * @return a new APIResponse instance indicating success with default code, provided info, and data
     */
     ...
     * @param message the error message
     * @param <T>     the type of the response data
     * @return a new APIResponse instance indicating failure with the default code and provided message
     */
