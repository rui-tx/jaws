...
/**
 * Page represents a paginated result set with metadata for frontend consumption. Contains the
 * actual data along with pagination information like total pages, first/last page indicators, etc.
 *
...
public class Page<T> {
  ...
  /**
   * Transform this page's content to a different type. Useful for converting Page<Row> to
   * Page<SomeModel>.
   *
