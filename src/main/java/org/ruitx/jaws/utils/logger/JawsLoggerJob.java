 ...
 * <p>
 * This job processes a batch of log entries in a single database transaction, significantly
 * improving logging performance for high-throughput applications.
 */
public class JawsLoggerJob extends BaseJob {
  ...
  public JawsLoggerJob(Map<String, Object> payload) {
    super(JOB_TYPE, ExecutionMode.SEQUENTIAL, 1, 3, 30000L,
        payload); // High priority (1), 3 retries, 30s timeout
  }

  @Override
  public void execute() throws Exception {
    @SuppressWarnings("unchecked")
    List<Map<String, Object>> logEntryMaps = (List<Map<String, Object>>) getPayload().get(
        "logEntries");
    ...
    try {
      Mimir logsDb = Odin.getDB(Odin.LOGS_DB_NAME);
      ...
      try {
        ...
        Logger.debug("BatchLogWriterJob: Successfully wrote {} log entries to database",
            logEntryMaps.size());
