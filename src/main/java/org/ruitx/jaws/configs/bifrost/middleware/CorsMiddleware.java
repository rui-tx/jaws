...
/**
 * CorsMiddleware handles Cross-Origin Resource Sharing (CORS) headers. This middleware adds
 * appropriate CORS headers to responses and handles preflight requests.
 */
  ...
  public boolean handle(Yggdrasill.RequestContext context, MiddlewareChain chain) {
    try {
      ...
      response.setHeader("Access-Control-Allow-Headers",
          "Origin, X-Requested-With, Content-Type, Accept, Authorization, HX-Request, HX-Trigger, HX-Target, HX-Current-URL");
