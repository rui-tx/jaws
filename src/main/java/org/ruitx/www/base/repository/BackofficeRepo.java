...
import org.ruitx.jaws.utils.logger.LogEntry;
import org.ruitx.jaws.utils.logger.LogEntryMapper;
...
public class BackofficeRepo extends Repository {

  private final Mimir logsDb;

  public BackofficeRepo() {
    super(Odin.getDB());
    this.logsDb = Odin.getDB(Odin.LOGS_DB_NAME);
  }
