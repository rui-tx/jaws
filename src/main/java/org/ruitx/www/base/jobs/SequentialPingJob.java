package org.ruitx.www.base.jobs;
...
public class SequentialPingJob extends BaseJob {
  ...
  public SequentialPingJob(Map<String, Object> payload) {
    ...
    super(JOB_TYPE, ExecutionMode.SEQUENTIAL, 1, 1, 15000L,
        payload); // priority 1, 1 retry, 15s timeout
  }
  ...
  public void execute() throws Exception {
    ...
    try {
      ...
      Logger.info("Sequential ping job completed: {} (ping #{}, delay: {}ms)", getId(), pingNumber,
          delayMs);
