 ...
 * 
 * This is a lightweight job that demonstrates sequential processing behavior:
 * - Each ping runs one at a time (sequential execution)
 * - Multiple pings submitted together will queue and process in order
 * - Perfect for testing and demonstrating the sequential job system
 * 
 * Use cases for sequential pings:
 * - System health checks that shouldn't overlap
 * - Resource availability tests that need to run in order
 * - Simple demonstration of sequential vs parallel processing
 */
