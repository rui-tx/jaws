...
public class BackofficeService {
   ...
   */
  public Context getFilteredLogTableData(PageRequest pageRequest, String level, String source,
      String search) {
    Page<Map<String, String>> logPage = backofficeRepo.getFilteredLogs(pageRequest, level, source,
        search);
    Map<String, Object> data = Map.of(
        "headers", Arrays.asList("Timestamp", "Level", "Message", "Source"),
        "rows", logPage.getContent(),
   ...
   */
  public Context getFilteredUserTableData(PageRequest pageRequest, String status, String role,
      String search) {
    Page<Map<String, String>> userPage = backofficeRepo.getFilteredUsers(pageRequest, status, role,
        search);
    Map<String, Object> data = Map.of(
        "headers", Arrays.asList("Username", "Email", "Name", "Status", "Last Login", "Created"),
        "rows", userPage.getContent(),
